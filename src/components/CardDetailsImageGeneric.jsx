...
const CardDetailsImageGeneric = (props) => {
            ...
            <div class="flex justify-center">
                ...
                <div ref={cardInner} id="cardInner" class="md:w-9/12 items-center rotateBase cardImage flex" style='aspect-ratio:1/1.4;'>
                    <div ref={cardFront} id="front" class="flipBaseFront">
                        <CardImage imageUrl={props.selectedImage} />
                    </div>
                    <div ref={cardBack} id="back" class="flipBaseBack">
                        <CardImage imageUrl={'https://backs.scryfall.io/large/2/2/222b7a3b-2321-4d4c-af19-19338b134971.jpg?1677416389'} />
                    </div>
                </div>
            </div>
        </div>
...
export default CardDetailsImageGeneric;